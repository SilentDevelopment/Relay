...
public class GreedyComponentParser implements ArgumentParser<Component> {
    ...
    public ParseResult<Component> parse(ArgumentReader reader) {
        ...
        return ParseResult.success(MiniMessage.miniMessage().deserialize(reader.readRemaining()));
    }
